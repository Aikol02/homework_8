...
#
#
# def select_all_products_whose_price_and_begure_than(conn, price, quantity):
#     try:
#         sql = '''select product title, price, quantity from products where price <= ?;'''
#         c = conn.cursor()
#         c.execute(sql, (price))
...
#     select_all_product(conn)
#     select_all_products_whose_price_and_begure_than(conn, 100, 5)
#     conn.close()
#
